...
`ifndef FIR_FILTER_REFERENCE_MODEL_SV
`define FIR_FILTER_REFERENCE_MODEL_SV

class fir_filter_reference_model extends uvm_component;
    ...
    `uvm_component_utils_begin(fir_filter_reference_model)
