...
//
//==============================================================
`ifndef FIR_FILTER_SCOREBOARD__SV                                                       
    `define FIR_FILTER_SCOREBOARD__SV                                                   
                                                                                               
                                                                                               
    class fir_filter_scoreboard extends uvm_component;                                        
                                                                                               
        fir_filter_reference_model refm;                                                      
                                                                                               
                                                                                               
        `uvm_component_utils_begin(fir_filter_scoreboard)                                     
