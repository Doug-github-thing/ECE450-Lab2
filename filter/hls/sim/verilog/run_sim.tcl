...
if {[file isfile fir_filter.autotvin.dat]} {
	file delete -force fir_filter.autotvin.dat
}

if {[file isfile fir_filter.autotvout.dat]} {
	file delete -force fir_filter.autotvout.dat
}
