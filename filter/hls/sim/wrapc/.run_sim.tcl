...
# 
# ==============================================================
set ::env(LD_LIBRARY_PATH) /Xilinx/2025.1/Vitis/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /Xilinx/2025.1/Vitis/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /Xilinx/2025.1/Vitis/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /Xilinx/2025.1/Vitis/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /Xilinx/2025.1/Vitis/tps/lnx64/gcc-8.3.0/lib:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /Xilinx/2025.1/Vitis/lib/lnx64.o/Default:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fir_filter.autotvin.dat"
	set constFileTvOut       "fir_filter.autotvout.dat"
	set constFileHdlTvIn     "fir_filter.autohdltvin.dat"
	set constFileHdlTvOut    "fir_filter.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
