...
using hls::sim::Byte;
extern "C" void fir_filter(Byte<4>*, Byte<4>*);
extern "C" void apatb_fir_filter_hw(volatile void * __xlx_apatb_param_in_r, volatile void * __xlx_apatb_param_out_r) {
...
__xlx_out_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_out_r)[i]);
  ...
  // DUT call
  fir_filter(__xlx_in_r__tmp_vec.data(), __xlx_out_r__tmp_vec.data());
